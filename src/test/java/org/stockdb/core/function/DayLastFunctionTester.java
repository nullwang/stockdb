...
public class DayLastFunctionTester {

    @Test
    public void testGetData()
    {
        DayLastFunction dayLastFunction = new DayLastFunction();
        ...
        DataPoint [] ds = dayLastFunction.call(dataPoints);
        assertTrue(ds.length == 2);
        assertTrue(ds[0].equals(new DataPoint("201601011314","v1314"))
                && ds[1].equals(new DataPoint("201601020301","v2345"))
                ||
                        ds[1].equals(new DataPoint("201601011314","v1314"))
                                && ds[0].equals(new DataPoint("201601020301","v2345"))
        );
    }
}
