...
public class DayMaxFunctionTester {

    @Test
    public void testGetData()
    {
        DayMaxFunction dayMaxFunction = new DayMaxFunction();
        ...
        DataPoint [] ds = dayMaxFunction.call(dataPoints);
        assertTrue(ds.length == 2);
        assertTrue(ds[0].equals(new DataPoint("201601010114","1314123"))
                && ds[1].equals(new DataPoint("201601020301","2345"))
                ||
                        ds[1].equals(new DataPoint("201601010114","1314123"))
                                && ds[0].equals(new DataPoint("201601020301","2345"))
        );
    }
}
